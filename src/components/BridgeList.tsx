...
const BridgeList: React.FC<BridgeListProps> = ({ bridges, setSelectedStructureNumber }) => {

  return (
    <div className="p-5 pt-0 h-screen overflow-y-auto min-w-[300px] bg-white shadow-md rounded-md space-y-4 text-black">
        <h2 className="text-xl font-semibold sticky top-0 bg-white z-10 p-5 border-b border-b-gray-500 w-full">Bridges List</h2>
  ...
  <p className="text-base text-gray-800">Click on "Apply Filters" to start</p>
)}
